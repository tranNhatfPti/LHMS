 ...
 * @author admin
 */
public class ListNotificationLandlord extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListNotificationLandlord</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListNotificationLandlord at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
       ...
       request.getRequestDispatcher("view/landlord/list-notification-landlord.jsp").forward(request, response);
    } 

                        ...
                        <div class="card-body">
                            <form id="receiptForm" action="update-notification-for-tenant" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="price" value="${requestScope.price}"  readonly="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="content" value="${requestScope.description}"readonly="">
                                </div>
                                <c:choose>
                                    ...
                                    <c:when test="${notificationDateFormatted >= currentDateFormatted && notification.isConfirmationStatus() == 0}">
                                        ...
                                        <button type="submit" name="action" value="check" class="btn btn-success mr-2">Đồng ý</button>
                                        <button type="submit" name="action" value="cross" class="btn btn-danger">Không đồng ý</button>
                                    </c:when>
                                </c:choose>

 ...
 * @author admin
 */
public class ListNotificationForManager extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListNotificationForManager</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListNotificationForManager at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Notification> listN = notificationDAO.getNotificationBySenderId(account.getAccountID());
   ...
   request.getRequestDispatcher("/view/manager/list-notification-for-manager.jsp").forward(request, response);
    } 

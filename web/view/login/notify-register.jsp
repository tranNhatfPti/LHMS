<%-- 
    Document   : notify-register
    Created on : May 24, 2024, 11:48:06 PM
    Author     : ASUS ZenBook
--%>
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" style="width: 650px">
                        <span class="login100-form-title" style="color: brown">
                            <%
                                String msRegistered = (String) request.getAttribute("msRegistered");
                                if(msRegistered != null){
                            %>
                            <b><%=msRegistered%></b>
                            <%} else {%>
                            <b>Hãy kiểm tra email của bạn để xác nhận đăng kí, nếu không tìm thấy email xác nhận vui lòng kiểm tra 
                                lại trong thư mục spam và đảm bảo rằng email bạn chính xác.</b>
                            <%}%>
                        </span>

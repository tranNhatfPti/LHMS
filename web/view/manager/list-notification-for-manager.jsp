...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                <li>
                    <a id="notificationLink " href="list-notification-for-manager" class="app-menu__item active">
            ...
            <div id="table-body">
                ...
                <div class="pagination">
                    ...
                    <c:if test="${currentPage > 1}">
                        <a href="list-notification-for-manager?curentPage=${currentPage - 1}" >&laquo;</a>
                    </c:if>
                    <c:forEach  begin="${sessionScope.pagination.getStart()}" end="${sessionScope.pagination.getEnd()}" var="num">   
                        <c:if test="${num != 0}">
                            <c:if test="${num == currentPage}">
                                <a href="list-notification-for-manager?curentPage=${num}"  class="active">${num}</a>
                            </c:if>
                            <c:if test="${num != currentPage}">
                                <a href="list-notification-for-manager?curentPage=${num}" >${num}</a>
                            </c:if>   
                        </c:if>
                    </c:forEach>
                    <c:if test="${sessionScope.pagination.getNumberOfPage() > currentPage}">
                        <a href="list-notification-for-manager?curentPage=${currentPage + 1}">&raquo;</a>
                    </c:if>
                </div>   
            </div>

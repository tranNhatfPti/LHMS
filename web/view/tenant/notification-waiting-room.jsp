            ...
            <div class="col-sm-2">
                ...
                <aside class="app-sidebar">
                    ...
                    <ul class="app-menu">
                        ...
                        <li><a class="app-menu__item" href="tenant-contract-servlet?statusAccept=1"><i class='app-menu__icon bx bx-log-out'></i><span
                                    class="app-menu__label">Hợp đồng</span></a></li>

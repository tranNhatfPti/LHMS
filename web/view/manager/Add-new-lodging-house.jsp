    ...
    <body class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item " href="management-lodging-houses"><i class='app-menu__icon bx bx-id-card'></i> <span
                ...
                <form id="addLodgingForm" action="add-lodging-house" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="addressDetail" class="form-control" id="addressDetail" placeholder="Nhập địa chỉ cụ thể" required>

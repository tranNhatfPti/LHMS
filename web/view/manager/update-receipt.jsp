            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <c:set value="${requestScope.receipt}" var="r" />
                            <form id="receiptForm" action="update-receipt" method="post">
                                <div class="form-group">
                                    <label for="receiptNumber"><i class="fas fa-tag mr-1"></i> Số phiếu:</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="receiptNumber" value="Auto generated" readonly="">
                                    </div>
                                </div>
                                <input type="hidden" class="form-control" name="receiptID" value="${r.getReceiptId()}">
                                <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <c:forEach items="${listAccount}" var="c">
                                        <c:if   test="${c.getAccountID()==r.getAccountId()}">
                                        <input list="email-list" id="customerEmail" name="tenantEmail" class="form-control" type="email" required placeholder="Enter email addresses separated by commas" value="${c.getEmail()}" multiple> </c:if>
                                    </c:forEach>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="price" autocomplete="off"  name="price" value="${r.getPrice()}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="content" autocomplete="off" name="description" value="${r.getDescription()}">
                                </div>
